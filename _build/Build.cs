...
internal class Build : NukeBuild
{
    ...
    Target DeployFrontEnd => _ => _
        ...
        .Executes(() =>
        {
            var scriptsDestination = RootDirectory / "resources" / "scripts" / "ionictodo";
            EnsureCleanDirectory(scriptsDestination);
            CopyDirectoryRecursively(RootDirectory / "module.web" / "dist" / "ionictodo", scriptsDestination, DirectoryExistsPolicy.Merge);
        });
    ...
    Target Swagger => _ => _
        ...
        .Executes(() =>
        {
            ...
            NSwagTasks.NSwagWebApiToOpenApi(c => c
                .AddAssembly(RootDirectory / "bin" / Configuration / "DNNDave.Modules.IonicToDo.dll")
                .SetInfoTitle("DNN Dave Ionic ToDo")
